"""
Django settings for fact_builder_46251 project.
...
ROOT_URLCONF = 'fact_builder_46251.urls'
...
WSGI_APPLICATION = 'fact_builder_46251.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fact_builder_46251 API",
    "DESCRIPTION": "API documentation for fact_builder_46251 App",
    "VERSION": "v1",
}
